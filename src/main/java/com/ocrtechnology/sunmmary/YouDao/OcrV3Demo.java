package com.ocrtechnology.sunmmary.YouDao;
...
public class OcrV3Demo {
    ...
    private static final String APP_KEY = "779b10c1dcf45fc3";

    private static final String APP_SECRET = "wOq8VT4S2tVmJOEW6yDHeJstm52eVsG6";

    public static void main(String[] args) throws IOException {

        Map<String,String> params = new HashMap<String,String>();
        String q = loadAsBase64("C:\\Users\\sunwukong\\Desktop\\FF6AA31A-3419-4133-8CC6-DFF245C02381.png");
